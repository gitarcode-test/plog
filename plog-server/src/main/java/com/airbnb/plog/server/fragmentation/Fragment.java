...
public final class Fragment extends DefaultByteBufHolder implements Tagged {
  ...
  @Getter private final int fragmentCount;
  @Getter private final int fragmentIndex;
  @Getter private final int fragmentSize;
  @Getter private final long msgId;
  @Getter private final int totalLength;
  @Getter private final int msgHash;
  ...
  public static Fragment fromDatagram(DatagramPacket packet) {
    ...
    final ByteBuf tagsBuffer =
        tagsBufferLength == 0 ? null : content.slice(HEADER_SIZE, tagsBufferLength);
